...
// WebGL1-compatible fragment shader (GLSL 1.0)
// Differences vs GLSL3 version:
// - Uses gl_FragColor instead of an out variable
// - Enables standard derivatives for fwidth via material.extensions.derivatives
    ...
    useEffect(() => {
        ...
        if (mustReinit) {
            ...
            const material = new THREE.ShaderMaterial({
                ...
                fragmentShader: (gl as WebGL2RenderingContext | null) && isWebGL2 ? FRAGMENT_SRC : FRAGMENT_SRC_GLSL1,
                uniforms,
                transparent: true,
                depthTest: false,
                depthWrite: false,
                // Use GLSL3 for WebGL2, enable derivatives extension for WebGL1
                ...(isWebGL2 ? { glslVersion: (THREE as any).GLSL3 } : { extensions: { derivatives: true } })
            });
            ...
            // Only enable the liquid postprocessing effect on WebGL2 for broader compatibility (iOS WebGL1 fallback)
            if (liquid && isWebGL2) {
